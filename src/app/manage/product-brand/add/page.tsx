...
export default function Page() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!result.ok) throw new Error("Failed to save product brand data.");

      toast.success("Product brand successfully added.");
    ...
    <AppShell>
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div className="text-xs text-gray-400">
              Kelola Cabang &nbsp;›&nbsp; Merk Produk &nbsp;›&nbsp; Tambah
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 w-full rounded-2xl bg-white border border-gray-200 p-5 shadow-sm">
        ...
        <div className="mt-5 flex items-center justify-end gap-2">
          <button
            type="button"
            onClick={() => router.push("/manage/product-brand")}
